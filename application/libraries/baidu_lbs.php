...
class Baidu_lbs {
    ...
    public function __construct($params)
    {
		...
		$helpers=$params['helpers']?$params['helpers']:null;
    ...
    public function process_response($curl_handle = null, $response = null)
    {
        ...
        if (is_resource($this->curl_handle))
        {
            ...
            if ($curl_handle && $response)
            {
                return $response=array('response_headers'=>$this->response_headers, 'response_body'=>$this->response_body, 'response_code'=>$this->response_code, 'curl_handle'=>$this->curl_handle);
            }
        }
