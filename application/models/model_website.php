...
class Model_website extends CI_Model
{
    ...
    function __construct()
    {
        ...
        $this->website_table = $db['dbprefix'].'siteweb';
    }
    
  
    public function getwebList($type,$nums)
    {
    	$adList = $this->db->where('type',$type)->limit($nums,0)->order_by('ordernum','desc')->get($this->website_table)->result_array() ;
