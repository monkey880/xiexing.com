...
$(document).ready(function(){
	...
	$("#username").formValidator({onShow:"请输入手机号",onFocus:"",onCorrect:" "}).inputValidator({min:11,max:11,onError:"请输入正确的手机号码"}).regexValidator({regExp:"mobile",dataType:"enum",onError:"你输入的手机号码格式不正确"});
        ...
        <ul id="errorlist"></ul>
          <ul>
            <li>
              ...
              <span  class="col_help">请输入手机号码</span> </li>
            <li>
