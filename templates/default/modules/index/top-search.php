<?php 
    ...
    $searchArray = $ci->model_common->setLeftSearch();
...
<div class="dp">
  ...
  全国&nbsp;<font class="f_b1_f00">共有<?php echo $allnums ?></font>&nbsp;<font class="">家酒店</font>
...
<ul class="why_us">
        <li class="title">为什么选择我们</li>
        <li>低价高返现 高于前台挂牌价<span class="col_org">3倍差额赔付</span></li>
        <li>订七送一 累计预订七间夜并入住<span class="col_org">赠送一天</span></li>
        <li>订六送一 连续预订六天并入住<span class="col_org">赠送一天</span></li>
        <li>0元试住无门槛 真正<span class="col_org">免费住酒店</span></li>
        <li><span class="col_org">免费礼品</span>无需积分兑换</li>
