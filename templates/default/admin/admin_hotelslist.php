            ...
            <tr><td>
                   ...
                   <table width="100%" class="ym_list" cellpadding="0" cellspacing="0">
                       ...
                       <tr>
                        ...
                        <td class=""><input name="hotel_box" type="checkbox" value="<?php echo $hotel['hid'] ;?>" /></td>

                        <td class="left"><a target="_blank" href="<?php echo site_url('/hotelinfo/'.$hotel['hotel_id']) ;?>"><?php echo $hotel['HotelName'] ;?></a></td>

                        <td class="f_f60"><?php echo $hotel['CityName'];?></td>

                        <td><?php echo $hotel['star'];?></td>

                        <td class="f_f60"><?php echo $hotel['soure'];?>
