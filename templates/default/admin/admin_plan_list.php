            ...
            <tr><td>
                   ...
                   <table width="100%" class="ym_list" cellpadding="0" cellspacing="0">
                       ...
                       <tr class="bt">
                        ...
                        <td style="border-left:none;">开始时间</td>

                        <td style="border-left:none;">结束时间</td>

                        <td style="border-left:none;">周别</td>

                        <td style="border-left:none;">价格</td>
                        
                        <td style="border-left:none;">担保规则</td>
                        
                        <td style="border-left:none;">门市价格</td>
                       ...
                       <tr>
                        ...
                        <td class="left"><?php echo $hotel['planname'] ;?></td>

                        <td class="f_f60"><?php 
						
						echo date('Y-m-d',$hotel['startdate']);
						?></td>

                        <td><?php echo date('Y-m-d',$hotel['enddate']);?></td>

                        <td class="f_f60"><?php echo $hotel['week'];?></td>
                        
                        <td class="f_f60"><?php echo $hotel['dayprice'];?></td>
                        
                         <td class="f_f60"><?php echo $hotel['ruleid'];?></td>
                        
                        <td class="f_f60"><?php echo $hotel['meishi']?>
                        
                        </td>
                        
                        <td class="f_f60"><?php echo $hotel['status'];?></td>

                       <td><?php if ($operate['isdel']) { ?><a class="sc" href="javascript:void(0)" <?php if ($hotel['planid'] > 1){?>onclick="delete_one_hotel('<?php echo $hotel['planid'] ?>',<?php echo $hotel['rid'] ?>)"<?php }?>>删除</a><?php } ?><?php if ($operate['isedit']) { ?><a class="xg" href="<?php echo site_url(CFG_ADMINURL.'/hotel/add_plan/'.$hotel['rid'].'/'.$hotel['planid']); ?>">修改</a><?php } ?> </td></tr>
