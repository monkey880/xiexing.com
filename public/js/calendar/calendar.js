...
document.write('<iframe id=CalFrame name=CalFrame src="/public/js/calendar/calendar.html" frameborder=0 style="display:none;position:absolute;z-index:110" onload="loadCalendarHtm();"></iframe>');
...

{
	...
	{		 
	    ...
	    loadCalendarHtm = function(){showCalendar(sFld1,sNextD,sCallback,sFld2)};cf.src = "/public/js/calendar/calendar.html";	   	    	
