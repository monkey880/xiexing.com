...
<script src="/uploadify/jquery.Jcrop.min.js" type="text/javascript"></script>
<link rel="stylesheet" href="/uploadify/jquery.Jcrop.css" type="text/css" />
...
$(document).ready(function() {
  ...
  $('#cropButton img').bind('click',function(){
	  		...
	  		$.post("/uploadify/upSave.php","filename="+$('#filename').val()+"&filewidth="+$('#filewidth').val()+"&resize_width="+$('#resize_width').val()+"&x1="+$('#x1').val()+"&x2="+$('#x2').val()+"&y1="+$('#y1').val()+"&y2="+$('#y2').val(),function(msg){
